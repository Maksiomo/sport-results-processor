...
var BlockchainMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
func (_Blockchain *BlockchainCaller) ValidateSport(opts *bind.CallOpts, id *big.Int, recordHash [32]byte) (bool, error) {
	var out []interface{}
	err := _Blockchain.contract.Call(opts, &out, "validateSport", id, recordHash)
...
//
// Solidity: function validateSport(uint256 id, bytes32 recordHash) view returns(bool)
func (_Blockchain *BlockchainSession) ValidateSport(id *big.Int, recordHash [32]byte) (bool, error) {
	return _Blockchain.Contract.ValidateSport(&_Blockchain.CallOpts, id, recordHash)
}

// ValidateSport is a free data retrieval call binding the contract method 0xbec12103.
//
// Solidity: function validateSport(uint256 id, bytes32 recordHash) view returns(bool)
func (_Blockchain *BlockchainCallerSession) ValidateSport(id *big.Int, recordHash [32]byte) (bool, error) {
	return _Blockchain.Contract.ValidateSport(&_Blockchain.CallOpts, id, recordHash)
}
...
func (_Blockchain *BlockchainTransactor) RecordSport(opts *bind.TransactOpts, id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.contract.Transact(opts, "recordSport", id, recordHash)
}

// RecordSport is a paid mutator transaction binding the contract method 0xd76c9386.
//
// Solidity: function recordSport(uint256 id, bytes32 recordHash) returns()
func (_Blockchain *BlockchainSession) RecordSport(id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.Contract.RecordSport(&_Blockchain.TransactOpts, id, recordHash)
}

// RecordSport is a paid mutator transaction binding the contract method 0xd76c9386.
//
// Solidity: function recordSport(uint256 id, bytes32 recordHash) returns()
func (_Blockchain *BlockchainTransactorSession) RecordSport(id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.Contract.RecordSport(&_Blockchain.TransactOpts, id, recordHash)
}

// BlockchainSportRecordedIterator is returned from FilterSportRecorded and is used to iterate over the raw logs and unpacked data for SportRecorded events raised by the Blockchain contract.
type BlockchainSportRecordedIterator struct {
	Event *BlockchainSportRecorded // Event containing the contract specifics and raw log
...
func (it *BlockchainSportRecordedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BlockchainSportRecorded)
...
func (it *BlockchainSportRecordedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BlockchainSportRecordedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BlockchainSportRecorded represents a SportRecorded event raised by the Blockchain contract.
type BlockchainSportRecorded struct {
	Id         *big.Int
	RecordHash [32]byte
...
func (_Blockchain *BlockchainFilterer) FilterSportRecorded(opts *bind.FilterOpts, id []*big.Int) (*BlockchainSportRecordedIterator, error) {
	...
	logs, sub, err := _Blockchain.contract.FilterLogs(opts, "SportRecorded", idRule)
	if err != nil {
		return nil, err
	}
	return &BlockchainSportRecordedIterator{contract: _Blockchain.contract, event: "SportRecorded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SportRecorded(uint256 indexed id, bytes32 recordHash)
func (_Blockchain *BlockchainFilterer) WatchSportRecorded(opts *bind.WatchOpts, sink chan<- *BlockchainSportRecorded, id []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Blockchain.contract.WatchLogs(opts, "SportRecorded", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(BlockchainSportRecorded)
				if err := _Blockchain.contract.UnpackLog(event, "SportRecorded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SportRecorded(uint256 indexed id, bytes32 recordHash)
func (_Blockchain *BlockchainFilterer) ParseSportRecorded(log types.Log) (*BlockchainSportRecorded, error) {
	event := new(BlockchainSportRecorded)
	if err := _Blockchain.contract.UnpackLog(event, "SportRecorded", log); err != nil {
		return nil, err
	}
