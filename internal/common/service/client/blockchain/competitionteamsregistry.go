...
var BlockchainMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
func (_Blockchain *BlockchainCaller) ValidateCompetitionTeams(opts *bind.CallOpts, id *big.Int, recordHash [32]byte) (bool, error) {
	var out []interface{}
	err := _Blockchain.contract.Call(opts, &out, "validateCompetitionTeams", id, recordHash)
...
//
// Solidity: function validateCompetitionTeams(uint256 id, bytes32 recordHash) view returns(bool)
func (_Blockchain *BlockchainSession) ValidateCompetitionTeams(id *big.Int, recordHash [32]byte) (bool, error) {
	return _Blockchain.Contract.ValidateCompetitionTeams(&_Blockchain.CallOpts, id, recordHash)
}

// ValidateCompetitionTeams is a free data retrieval call binding the contract method 0x4516146e.
//
// Solidity: function validateCompetitionTeams(uint256 id, bytes32 recordHash) view returns(bool)
func (_Blockchain *BlockchainCallerSession) ValidateCompetitionTeams(id *big.Int, recordHash [32]byte) (bool, error) {
	return _Blockchain.Contract.ValidateCompetitionTeams(&_Blockchain.CallOpts, id, recordHash)
}
...
func (_Blockchain *BlockchainTransactor) RecordCompetitionTeams(opts *bind.TransactOpts, id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.contract.Transact(opts, "recordCompetitionTeams", id, recordHash)
}

// RecordCompetitionTeams is a paid mutator transaction binding the contract method 0x334e90af.
//
// Solidity: function recordCompetitionTeams(uint256 id, bytes32 recordHash) returns()
func (_Blockchain *BlockchainSession) RecordCompetitionTeams(id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.Contract.RecordCompetitionTeams(&_Blockchain.TransactOpts, id, recordHash)
}

// RecordCompetitionTeams is a paid mutator transaction binding the contract method 0x334e90af.
//
// Solidity: function recordCompetitionTeams(uint256 id, bytes32 recordHash) returns()
func (_Blockchain *BlockchainTransactorSession) RecordCompetitionTeams(id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.Contract.RecordCompetitionTeams(&_Blockchain.TransactOpts, id, recordHash)
}

// BlockchainCompetitionTeamsRecordedIterator is returned from FilterCompetitionTeamsRecorded and is used to iterate over the raw logs and unpacked data for CompetitionTeamsRecorded events raised by the Blockchain contract.
type BlockchainCompetitionTeamsRecordedIterator struct {
	Event *BlockchainCompetitionTeamsRecorded // Event containing the contract specifics and raw log
...
func (it *BlockchainCompetitionTeamsRecordedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BlockchainCompetitionTeamsRecorded)
...
func (it *BlockchainCompetitionTeamsRecordedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BlockchainCompetitionTeamsRecordedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BlockchainCompetitionTeamsRecorded represents a CompetitionTeamsRecorded event raised by the Blockchain contract.
type BlockchainCompetitionTeamsRecorded struct {
	Id         *big.Int
	RecordHash [32]byte
...
func (_Blockchain *BlockchainFilterer) FilterCompetitionTeamsRecorded(opts *bind.FilterOpts, id []*big.Int) (*BlockchainCompetitionTeamsRecordedIterator, error) {
	...
	logs, sub, err := _Blockchain.contract.FilterLogs(opts, "CompetitionTeamsRecorded", idRule)
	if err != nil {
		return nil, err
	}
	return &BlockchainCompetitionTeamsRecordedIterator{contract: _Blockchain.contract, event: "CompetitionTeamsRecorded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event CompetitionTeamsRecorded(uint256 indexed id, bytes32 recordHash)
func (_Blockchain *BlockchainFilterer) WatchCompetitionTeamsRecorded(opts *bind.WatchOpts, sink chan<- *BlockchainCompetitionTeamsRecorded, id []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Blockchain.contract.WatchLogs(opts, "CompetitionTeamsRecorded", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(BlockchainCompetitionTeamsRecorded)
				if err := _Blockchain.contract.UnpackLog(event, "CompetitionTeamsRecorded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event CompetitionTeamsRecorded(uint256 indexed id, bytes32 recordHash)
func (_Blockchain *BlockchainFilterer) ParseCompetitionTeamsRecorded(log types.Log) (*BlockchainCompetitionTeamsRecorded, error) {
	event := new(BlockchainCompetitionTeamsRecorded)
	if err := _Blockchain.contract.UnpackLog(event, "CompetitionTeamsRecorded", log); err != nil {
		return nil, err
	}
