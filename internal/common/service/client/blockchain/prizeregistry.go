...
var BlockchainMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
func (_Blockchain *BlockchainCaller) ValidatePrize(opts *bind.CallOpts, id *big.Int, recordHash [32]byte) (bool, error) {
	var out []interface{}
	err := _Blockchain.contract.Call(opts, &out, "validatePrize", id, recordHash)
...
//
// Solidity: function validatePrize(uint256 id, bytes32 recordHash) view returns(bool)
func (_Blockchain *BlockchainSession) ValidatePrize(id *big.Int, recordHash [32]byte) (bool, error) {
	return _Blockchain.Contract.ValidatePrize(&_Blockchain.CallOpts, id, recordHash)
}

// ValidatePrize is a free data retrieval call binding the contract method 0x6e7a2303.
//
// Solidity: function validatePrize(uint256 id, bytes32 recordHash) view returns(bool)
func (_Blockchain *BlockchainCallerSession) ValidatePrize(id *big.Int, recordHash [32]byte) (bool, error) {
	return _Blockchain.Contract.ValidatePrize(&_Blockchain.CallOpts, id, recordHash)
}
...
func (_Blockchain *BlockchainTransactor) RecordPrize(opts *bind.TransactOpts, id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.contract.Transact(opts, "recordPrize", id, recordHash)
}

// RecordPrize is a paid mutator transaction binding the contract method 0xd6b2e79c.
//
// Solidity: function recordPrize(uint256 id, bytes32 recordHash) returns()
func (_Blockchain *BlockchainSession) RecordPrize(id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.Contract.RecordPrize(&_Blockchain.TransactOpts, id, recordHash)
}

// RecordPrize is a paid mutator transaction binding the contract method 0xd6b2e79c.
//
// Solidity: function recordPrize(uint256 id, bytes32 recordHash) returns()
func (_Blockchain *BlockchainTransactorSession) RecordPrize(id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.Contract.RecordPrize(&_Blockchain.TransactOpts, id, recordHash)
}

// BlockchainPrizeRecordedIterator is returned from FilterPrizeRecorded and is used to iterate over the raw logs and unpacked data for PrizeRecorded events raised by the Blockchain contract.
type BlockchainPrizeRecordedIterator struct {
	Event *BlockchainPrizeRecorded // Event containing the contract specifics and raw log
...
func (it *BlockchainPrizeRecordedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BlockchainPrizeRecorded)
...
func (it *BlockchainPrizeRecordedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BlockchainPrizeRecordedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BlockchainPrizeRecorded represents a PrizeRecorded event raised by the Blockchain contract.
type BlockchainPrizeRecorded struct {
	Id         *big.Int
	RecordHash [32]byte
...
func (_Blockchain *BlockchainFilterer) FilterPrizeRecorded(opts *bind.FilterOpts, id []*big.Int) (*BlockchainPrizeRecordedIterator, error) {
	...
	logs, sub, err := _Blockchain.contract.FilterLogs(opts, "PrizeRecorded", idRule)
	if err != nil {
		return nil, err
	}
	return &BlockchainPrizeRecordedIterator{contract: _Blockchain.contract, event: "PrizeRecorded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event PrizeRecorded(uint256 indexed id, bytes32 recordHash)
func (_Blockchain *BlockchainFilterer) WatchPrizeRecorded(opts *bind.WatchOpts, sink chan<- *BlockchainPrizeRecorded, id []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Blockchain.contract.WatchLogs(opts, "PrizeRecorded", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(BlockchainPrizeRecorded)
				if err := _Blockchain.contract.UnpackLog(event, "PrizeRecorded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event PrizeRecorded(uint256 indexed id, bytes32 recordHash)
func (_Blockchain *BlockchainFilterer) ParsePrizeRecorded(log types.Log) (*BlockchainPrizeRecorded, error) {
	event := new(BlockchainPrizeRecorded)
	if err := _Blockchain.contract.UnpackLog(event, "PrizeRecorded", log); err != nil {
		return nil, err
	}
