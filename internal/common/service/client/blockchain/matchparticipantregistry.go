...
var BlockchainMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
func (_Blockchain *BlockchainCaller) ValidateMatchParticipant(opts *bind.CallOpts, id *big.Int, recordHash [32]byte) (bool, error) {
	var out []interface{}
	err := _Blockchain.contract.Call(opts, &out, "validateMatchParticipant", id, recordHash)
...
//
// Solidity: function validateMatchParticipant(uint256 id, bytes32 recordHash) view returns(bool)
func (_Blockchain *BlockchainSession) ValidateMatchParticipant(id *big.Int, recordHash [32]byte) (bool, error) {
	return _Blockchain.Contract.ValidateMatchParticipant(&_Blockchain.CallOpts, id, recordHash)
}

// ValidateMatchParticipant is a free data retrieval call binding the contract method 0x70a9bd7c.
//
// Solidity: function validateMatchParticipant(uint256 id, bytes32 recordHash) view returns(bool)
func (_Blockchain *BlockchainCallerSession) ValidateMatchParticipant(id *big.Int, recordHash [32]byte) (bool, error) {
	return _Blockchain.Contract.ValidateMatchParticipant(&_Blockchain.CallOpts, id, recordHash)
}
...
func (_Blockchain *BlockchainTransactor) RecordMatchParticipant(opts *bind.TransactOpts, id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.contract.Transact(opts, "recordMatchParticipant", id, recordHash)
}

// RecordMatchParticipant is a paid mutator transaction binding the contract method 0xa33b5273.
//
// Solidity: function recordMatchParticipant(uint256 id, bytes32 recordHash) returns()
func (_Blockchain *BlockchainSession) RecordMatchParticipant(id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.Contract.RecordMatchParticipant(&_Blockchain.TransactOpts, id, recordHash)
}

// RecordMatchParticipant is a paid mutator transaction binding the contract method 0xa33b5273.
//
// Solidity: function recordMatchParticipant(uint256 id, bytes32 recordHash) returns()
func (_Blockchain *BlockchainTransactorSession) RecordMatchParticipant(id *big.Int, recordHash [32]byte) (*types.Transaction, error) {
	return _Blockchain.Contract.RecordMatchParticipant(&_Blockchain.TransactOpts, id, recordHash)
}

// BlockchainMatchParticipantRecordedIterator is returned from FilterMatchParticipantRecorded and is used to iterate over the raw logs and unpacked data for MatchParticipantRecorded events raised by the Blockchain contract.
type BlockchainMatchParticipantRecordedIterator struct {
	Event *BlockchainMatchParticipantRecorded // Event containing the contract specifics and raw log
...
func (it *BlockchainMatchParticipantRecordedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BlockchainMatchParticipantRecorded)
...
func (it *BlockchainMatchParticipantRecordedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BlockchainMatchParticipantRecordedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BlockchainMatchParticipantRecorded represents a MatchParticipantRecorded event raised by the Blockchain contract.
type BlockchainMatchParticipantRecorded struct {
	Id         *big.Int
	RecordHash [32]byte
...
func (_Blockchain *BlockchainFilterer) FilterMatchParticipantRecorded(opts *bind.FilterOpts, id []*big.Int) (*BlockchainMatchParticipantRecordedIterator, error) {
	...
	logs, sub, err := _Blockchain.contract.FilterLogs(opts, "MatchParticipantRecorded", idRule)
	if err != nil {
		return nil, err
	}
	return &BlockchainMatchParticipantRecordedIterator{contract: _Blockchain.contract, event: "MatchParticipantRecorded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event MatchParticipantRecorded(uint256 indexed id, bytes32 recordHash)
func (_Blockchain *BlockchainFilterer) WatchMatchParticipantRecorded(opts *bind.WatchOpts, sink chan<- *BlockchainMatchParticipantRecorded, id []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Blockchain.contract.WatchLogs(opts, "MatchParticipantRecorded", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(BlockchainMatchParticipantRecorded)
				if err := _Blockchain.contract.UnpackLog(event, "MatchParticipantRecorded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MatchParticipantRecorded(uint256 indexed id, bytes32 recordHash)
func (_Blockchain *BlockchainFilterer) ParseMatchParticipantRecorded(log types.Log) (*BlockchainMatchParticipantRecorded, error) {
	event := new(BlockchainMatchParticipantRecorded)
	if err := _Blockchain.contract.UnpackLog(event, "MatchParticipantRecorded", log); err != nil {
		return nil, err
	}
