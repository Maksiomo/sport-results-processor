...
var CompetitionWhere = struct {
	...
	UpdatedAt:  whereHelpertime_Time{field: "\"competition\".\"updated_at\""},
	RecordHash: whereHelpernull_Bytes{field: "\"competition\".\"record_hash\""},
...
var (
	competitionAllColumns            = []string{"id", "name", "sport_id", "location_id", "level_id", "created_at", "updated_at", "record_hash", "tx_hash"}
	competitionColumnsWithoutDefault = []string{"name", "sport_id", "location_id", "level_id"}
	competitionColumnsWithDefault    = []string{"id", "created_at", "updated_at", "record_hash", "tx_hash"}
