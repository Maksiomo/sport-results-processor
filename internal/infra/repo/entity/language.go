...
var LanguageTableColumns = struct {
	...
	RecordHash: "language.record_hash",
	TXHash:     "language.tx_hash",
}
...
var LanguageWhere = struct {
	...
	ID:         whereHelperint64{field: "\"language\".\"id\""},
	Name:       whereHelperstring{field: "\"language\".\"name\""},
	CreatedAt:  whereHelpertime_Time{field: "\"language\".\"created_at\""},
	UpdatedAt:  whereHelpertime_Time{field: "\"language\".\"updated_at\""},
	RecordHash: whereHelpernull_Bytes{field: "\"language\".\"record_hash\""},
	TXHash:     whereHelpernull_String{field: "\"language\".\"tx_hash\""},
}
...
var (
	languageAllColumns            = []string{"id", "name", "created_at", "updated_at", "record_hash", "tx_hash"}
	languageColumnsWithoutDefault = []string{"name"}
	languageColumnsWithDefault    = []string{"id", "created_at", "updated_at", "record_hash", "tx_hash"}
...
func (q languageQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Language, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for language")
	}
...
func (q languageQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count language rows")
	}
...
func (q languageQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if language exists")
	}
...
func FindLanguage(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Language, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from language")
	}
...
func (o *Language) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no language provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into language")
	}
...
func (o *Language) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update language, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update language row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for language")
	}
...
func (q languageQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for language")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for language")
	}
...
func (o *Language) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no language provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert language, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(languagePrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert language, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert language")
	}
...
func (o *Language) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from language")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for language")
	}
...
func (q languageQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from language")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for language")
	}
...
func LanguageExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if language exists")
	}
