...
var TeamAchievementTableColumns = struct {
	...
	UpdatedAt:  "team_achievements.updated_at",
...
var TeamAchievementWhere = struct {
	...
	UpdatedAt:  whereHelpertime_Time{field: "\"team_achievements\".\"updated_at\""},
...
var (
	teamAchievementAllColumns            = []string{"id", "team_id", "prize_id", "created_at", "updated_at", "record_hash", "tx_hash"}
	teamAchievementColumnsWithoutDefault = []string{"team_id", "prize_id"}
	teamAchievementColumnsWithDefault    = []string{"id", "created_at", "updated_at", "record_hash", "tx_hash"}
