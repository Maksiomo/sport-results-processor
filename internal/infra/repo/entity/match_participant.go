...
var MatchParticipantTableColumns = struct {
	...
	UpdatedAt:  "match_participant.updated_at",
...
var MatchParticipantWhere = struct {
	...
	UpdatedAt:  whereHelpertime_Time{field: "\"match_participant\".\"updated_at\""},
...
var (
	matchParticipantAllColumns            = []string{"id", "match_id", "team_id", "score", "is_winner", "created_at", "updated_at", "record_hash", "tx_hash"}
	matchParticipantColumnsWithoutDefault = []string{"match_id", "team_id", "score"}
	matchParticipantColumnsWithDefault    = []string{"id", "is_winner", "created_at", "updated_at", "record_hash", "tx_hash"}
