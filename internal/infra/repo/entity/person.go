...
func (o *Person) GetCountry() *Country {
	if o == nil {
		return nil
	}
...
func (r *personR) GetCountry() *Country {
	if r == nil {
		return nil
	}
...
func (o *Person) GetPersonSports() PersonSportSlice {
	if o == nil {
		return nil
	}
...
func (r *personR) GetPersonSports() PersonSportSlice {
	if r == nil {
		return nil
	}
...
func (o *Person) GetTeamPeople() TeamPersonSlice {
	if o == nil {
		return nil
	}
...
func (r *personR) GetTeamPeople() TeamPersonSlice {
	if r == nil {
		return nil
	}
...
var personAfterSelectMu sync.Mutex
var personAfterSelectHooks []PersonHook

var personBeforeInsertMu sync.Mutex
var personBeforeInsertHooks []PersonHook
var personAfterInsertMu sync.Mutex
var personAfterInsertHooks []PersonHook

var personBeforeUpdateMu sync.Mutex
var personBeforeUpdateHooks []PersonHook
var personAfterUpdateMu sync.Mutex
var personAfterUpdateHooks []PersonHook

var personBeforeDeleteMu sync.Mutex
var personBeforeDeleteHooks []PersonHook
var personAfterDeleteMu sync.Mutex
var personAfterDeleteHooks []PersonHook

var personBeforeUpsertMu sync.Mutex
var personBeforeUpsertHooks []PersonHook
var personAfterUpsertMu sync.Mutex
...
func (q personQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Person, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for person")
	}
...
func (q personQuery) All(ctx context.Context, exec boil.ContextExecutor) (PersonSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to Person slice")
	}
...
func (q personQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count person rows")
	}
...
func (q personQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if person exists")
	}
...
func (o *Person) Country(mods ...qm.QueryMod) countryQuery {
...
func (o *Person) PersonSports(mods ...qm.QueryMod) personSportQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"person_sport\".\"person_id\"=?", o.ID),
	)
...
func (o *Person) TeamPeople(mods ...qm.QueryMod) teamPersonQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"team_person\".\"person_id\"=?", o.ID),
	)
...
func (personL) LoadCountry(ctx context.Context, e boil.ContextExecutor, singular bool, maybePerson interface{}, mods queries.Applicator) error {
	var slice []*Person
	var object *Person
...
func (personL) LoadPersonSports(ctx context.Context, e boil.ContextExecutor, singular bool, maybePerson interface{}, mods queries.Applicator) error {
	var slice []*Person
	var object *Person
	...
	query := NewQuery(
		...
		qm.WhereIn(`person_sport.person_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (personL) LoadTeamPeople(ctx context.Context, e boil.ContextExecutor, singular bool, maybePerson interface{}, mods queries.Applicator) error {
	var slice []*Person
	var object *Person
	...
	query := NewQuery(
		qm.From(`team_person`),
		qm.WhereIn(`team_person.person_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetCountry of the person to the related item.
// Sets o.R.Country to related.
// Adds o to related.R.People.
func (o *Person) SetCountry(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Country) error {
	var err error
	if insert {
...
func (o *Person) AddPersonSports(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PersonSport) error {
	var err error
...
// Sets related.R.Person appropriately.
func (o *Person) AddTeamPeople(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TeamPerson) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.PersonID = o.ID
...
func FindPerson(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Person, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from person")
	}
...
func (o *Person) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no person provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into person")
	}
...
func (o *Person) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update person, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update person row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for person")
	}
...
func (q personQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for person")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for person")
	}
...
func (o PersonSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in person slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all person")
	}
	return rowsAff, nil
}
...
func (o *Person) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert person, could not build update column list")
		}

		ret := strmangle.SetComplement(personAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(personPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert person, could not build conflict column list")
			}

			conflict = make([]string, len(personPrimaryKeyColumns))
			copy(conflict, personPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"person\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert person")
	}
...
func (o *Person) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no Person provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from person")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for person")
	}
...
func (q personQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no personQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from person")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for person")
	}
...
func (o PersonSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from person slice")
	}
...
func (o *PersonSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in PersonSlice")
	}
...
func PersonExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if person exists")
	}
...
func (o *Person) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return PersonExists(ctx, exec, o.ID)
}
