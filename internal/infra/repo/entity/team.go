...
type teamR struct {
	...
	TeamPeople        TeamPersonSlice       `boil:"TeamPeople" json:"TeamPeople" toml:"TeamPeople" yaml:"TeamPeople"`
}
...
func (o *Team) GetCountry() *Country {
	if o == nil {
		return nil
	}
...
func (o *Team) GetCompetitionTeams() CompetitionTeamSlice {
	if o == nil {
		return nil
	}
...
func (r *teamR) GetCompetitionTeams() CompetitionTeamSlice {
	if r == nil {
		return nil
	}
...
func (o *Team) GetMatchParticipants() MatchParticipantSlice {
	if o == nil {
		return nil
	}

	return o.R.GetMatchParticipants()
}

func (r *teamR) GetMatchParticipants() MatchParticipantSlice {
	if r == nil {
		return nil
	}
...
func (o *Team) GetTeamAchievements() TeamAchievementSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTeamAchievements()
}

func (r *teamR) GetTeamAchievements() TeamAchievementSlice {
	if r == nil {
		return nil
	}
...
func (o *Team) GetTeamPeople() TeamPersonSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTeamPeople()
}

func (r *teamR) GetTeamPeople() TeamPersonSlice {
	if r == nil {
		return nil
	}
...
func (q teamQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Team, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for team")
	}
...
func (q teamQuery) All(ctx context.Context, exec boil.ContextExecutor) (TeamSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to Team slice")
	}
...
func (q teamQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count team rows")
	}
...
func (q teamQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if team exists")
	}
...
func (o *Team) CompetitionTeams(mods ...qm.QueryMod) competitionTeamQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"competition_teams\".\"team_id\"=?", o.ID),
	)
...
func (o *Team) MatchParticipants(mods ...qm.QueryMod) matchParticipantQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"match_participant\".\"team_id\"=?", o.ID),
	)
...
func (o *Team) TeamAchievements(mods ...qm.QueryMod) teamAchievementQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"team_achievements\".\"team_id\"=?", o.ID),
	)

	return TeamAchievements(queryMods...)
}

// TeamPeople retrieves all the team_person's TeamPeople with an executor.
func (o *Team) TeamPeople(mods ...qm.QueryMod) teamPersonQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"team_person\".\"team_id\"=?", o.ID),
	)

	return TeamPeople(queryMods...)
}

// LoadCountry allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (teamL) LoadCountry(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeam interface{}, mods queries.Applicator) error {
	var slice []*Team
	var object *Team
...
func (teamL) LoadCompetitionTeams(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeam interface{}, mods queries.Applicator) error {
	var slice []*Team
	var object *Team
	...
	query := NewQuery(
		...
		qm.WhereIn(`competition_teams.team_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (teamL) LoadMatchParticipants(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeam interface{}, mods queries.Applicator) error {
	var slice []*Team
	var object *Team
	...
	query := NewQuery(
		...
		qm.WhereIn(`match_participant.team_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (teamL) LoadTeamAchievements(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeam interface{}, mods queries.Applicator) error {
	var slice []*Team
	var object *Team
	...
	query := NewQuery(
		...
		qm.WhereIn(`team_achievements.team_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadTeamPeople allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (teamL) LoadTeamPeople(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTeam interface{}, mods queries.Applicator) error {
	var slice []*Team
	var object *Team
	...
	query := NewQuery(
		qm.From(`team_person`),
		qm.WhereIn(`team_person.team_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load team_person")
	}

	var resultSlice []*TeamPerson
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice team_person")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on team_person")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for team_person")
	}
	...
	if singular {
		object.R.TeamPeople = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &teamPersonR{}
			}
			foreign.R.Team = object
		}
		return nil
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.TeamID {
				local.R.TeamPeople = append(local.R.TeamPeople, foreign)
				if foreign.R == nil {
					foreign.R = &teamPersonR{}
				}
				foreign.R.Team = local
...
func (o *Team) SetCountry(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Country) error {
	var err error
	if insert {
...
func (o *Team) AddCompetitionTeams(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*CompetitionTeam) error {
	var err error
...
// Sets related.R.Team appropriately.
func (o *Team) AddMatchParticipants(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*MatchParticipant) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.TeamID = o.ID
...
// Sets related.R.Team appropriately.
func (o *Team) AddTeamAchievements(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TeamAchievement) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.TeamID = o.ID
...
// AddTeamPeople adds the given related objects to the existing relationships
// of the team, optionally inserting them as new records.
// Appends related to o.R.TeamPeople.
// Sets related.R.Team appropriately.
func (o *Team) AddTeamPeople(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TeamPerson) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.TeamID = o.ID
	...
	if o.R == nil {
		...
		o.R.TeamPeople = append(o.R.TeamPeople, related...)
	}
...
func FindTeam(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Team, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from team")
	}
...
func (o *Team) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no team provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into team")
	}
...
func (o *Team) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update team, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update team row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for team")
	}
...
func (q teamQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for team")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for team")
	}
...
func (o TeamSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in team slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all team")
	}
	return rowsAff, nil
}
...
func (o *Team) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no team provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert team, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(teamPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert team, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert team")
	}
...
func (o *Team) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no Team provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from team")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for team")
	}
...
func (q teamQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no teamQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from team")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for team")
	}
...
func (o TeamSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from team slice")
	}
...
func (o *TeamSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in TeamSlice")
	}
...
func TeamExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if team exists")
	}
