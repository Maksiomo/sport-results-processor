...
var TeamWhere = struct {
	...
	UpdatedAt:      whereHelpertime_Time{field: "\"team\".\"updated_at\""},
	RecordHash:     whereHelpernull_Bytes{field: "\"team\".\"record_hash\""},
...
var (
	teamAllColumns            = []string{"id", "name", "country_id", "foundation_date", "created_at", "updated_at", "record_hash", "tx_hash"}
	teamColumnsWithoutDefault = []string{"name", "country_id", "foundation_date"}
	teamColumnsWithDefault    = []string{"id", "created_at", "updated_at", "record_hash", "tx_hash"}
