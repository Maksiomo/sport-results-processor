...
var CurrencyRels = struct {
	CurrencyCodePrizes string
}{
	CurrencyCodePrizes: "CurrencyCodePrizes",
}

// currencyR is where relationships are stored.
type currencyR struct {
	CurrencyCodePrizes PrizeSlice `boil:"CurrencyCodePrizes" json:"CurrencyCodePrizes" toml:"CurrencyCodePrizes" yaml:"CurrencyCodePrizes"`
}
...
func (o *Currency) GetCurrencyCodePrizes() PrizeSlice {
	if o == nil {
		return nil
	}

	return o.R.GetCurrencyCodePrizes()
}

func (r *currencyR) GetCurrencyCodePrizes() PrizeSlice {
	if r == nil {
		return nil
	}

	return r.CurrencyCodePrizes
}
...
func (q currencyQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Currency, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for currency")
	}
...
func (q currencyQuery) All(ctx context.Context, exec boil.ContextExecutor) (CurrencySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to Currency slice")
	}
...
func (q currencyQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count currency rows")
	}
...
func (q currencyQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if currency exists")
	}

	return count > 0, nil
}

// CurrencyCodePrizes retrieves all the prize's Prizes with an executor via currency_code column.
func (o *Currency) CurrencyCodePrizes(mods ...qm.QueryMod) prizeQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"prize\".\"currency_code\"=?", o.Code),
	)

	return Prizes(queryMods...)
}

// LoadCurrencyCodePrizes allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (currencyL) LoadCurrencyCodePrizes(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCurrency interface{}, mods queries.Applicator) error {
	var slice []*Currency
	var object *Currency
	...
	query := NewQuery(
		qm.From(`prize`),
		qm.WhereIn(`prize.currency_code in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.CurrencyCodePrizes = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.Code == foreign.CurrencyCode {
				local.R.CurrencyCodePrizes = append(local.R.CurrencyCodePrizes, foreign)
				if foreign.R == nil {
					foreign.R = &prizeR{}
				}
...
// AddCurrencyCodePrizes adds the given related objects to the existing relationships
// of the currency, optionally inserting them as new records.
// Appends related to o.R.CurrencyCodePrizes.
// Sets related.R.CurrencyCodeCurrency appropriately.
func (o *Currency) AddCurrencyCodePrizes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Prize) error {
	var err error
	...
	if o.R == nil {
		o.R = &currencyR{
			CurrencyCodePrizes: related,
		}
	} else {
		o.R.CurrencyCodePrizes = append(o.R.CurrencyCodePrizes, related...)
	}
...
func FindCurrency(ctx context.Context, exec boil.ContextExecutor, code string, selectCols ...string) (*Currency, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from currency")
	}
...
func (o *Currency) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no currency provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into currency")
	}
...
func (o *Currency) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update currency, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update currency row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for currency")
	}
...
func (q currencyQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for currency")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for currency")
	}
...
func (o CurrencySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in currency slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all currency")
	}
	return rowsAff, nil
}
...
func (o *Currency) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert currency, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(currencyPrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert currency, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert currency")
	}
...
func (o *Currency) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no Currency provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from currency")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for currency")
	}
...
func (q currencyQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no currencyQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from currency")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for currency")
	}
...
func (o CurrencySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from currency slice")
	}
...
func (o *CurrencySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in CurrencySlice")
	}
...
func CurrencyExists(ctx context.Context, exec boil.ContextExecutor, code string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if currency exists")
	}
